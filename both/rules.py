...
class Rule:
    ...
    def check_word(self, word):
        word = word.lower()
        return (check_single_rule(word, self.rule_1_type, self.rule_1_letters) and check_single_rule(word, self.rule_2_type, self.rule_2_letters))

    def check_word_2(self, word):
        word = word.lower()
        return (check_single_rule(word, self.rule_1_type, self.rule_1_letters), check_single_rule(word, self.rule_2_type, self.rule_2_letters))
    ...
    def is_reasonable(self, difficulty):
        ...
        if (frequencies[1] > 0.00001 and frequencies[1] < 50 and frequencies[2] > 0.00001 and frequencies[2] < 50 and frequencies[3] > min_freq and frequencies[3] < max_freq):
            return True
        return False
